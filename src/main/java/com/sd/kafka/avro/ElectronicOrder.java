...
public class ElectronicOrder extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1324972643738306471L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ElectronicOrder\",\"namespace\":\"com.sd.kafka.avro\",\"fields\":[{\"name\":\"order_id\",\"type\":\"string\"},{\"name\":\"electronic_id\",\"type\":\"string\"},{\"name\":\"user_id\",\"type\":\"string\"},{\"name\":\"price\",\"type\":\"double\",\"default\":0.0},{\"name\":\"time\",\"type\":\"long\"}]}");
   ...
   */
  public static com.sd.kafka.avro.ElectronicOrder.Builder newBuilder() {
    return new com.sd.kafka.avro.ElectronicOrder.Builder();
  }
   ...
   * @return A new ElectronicOrder RecordBuilder
   */
  public static com.sd.kafka.avro.ElectronicOrder.Builder newBuilder(com.sd.kafka.avro.ElectronicOrder.Builder other) {
    if (other == null) {
      return new com.sd.kafka.avro.ElectronicOrder.Builder();
    } else {
      return new com.sd.kafka.avro.ElectronicOrder.Builder(other);
    }
  }
   ...
   * @return A new ElectronicOrder RecordBuilder
   */
  public static com.sd.kafka.avro.ElectronicOrder.Builder newBuilder(com.sd.kafka.avro.ElectronicOrder other) {
    if (other == null) {
      return new com.sd.kafka.avro.ElectronicOrder.Builder();
    } else {
      return new com.sd.kafka.avro.ElectronicOrder.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ElectronicOrder>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.sd.kafka.avro.ElectronicOrder.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.sd.kafka.avro.ElectronicOrder other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.order_id)) {
        this.order_id = data().deepCopy(fields()[0].schema(), other.order_id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sd.kafka.avro.ElectronicOrder.Builder setOrderId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sd.kafka.avro.ElectronicOrder.Builder clearOrderId() {
      order_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sd.kafka.avro.ElectronicOrder.Builder setElectronicId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sd.kafka.avro.ElectronicOrder.Builder clearElectronicId() {
      electronic_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sd.kafka.avro.ElectronicOrder.Builder setUserId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sd.kafka.avro.ElectronicOrder.Builder clearUserId() {
      user_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sd.kafka.avro.ElectronicOrder.Builder setPrice(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sd.kafka.avro.ElectronicOrder.Builder clearPrice() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sd.kafka.avro.ElectronicOrder.Builder setTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sd.kafka.avro.ElectronicOrder.Builder clearTime() {
