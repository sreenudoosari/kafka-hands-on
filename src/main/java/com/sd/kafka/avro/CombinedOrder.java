...
public class CombinedOrder extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4724898479093760334L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"CombinedOrder\",\"namespace\":\"com.sd.kafka.avro\",\"fields\":[{\"name\":\"electronic_order_id\",\"type\":\"string\"},{\"name\":\"appliance_order_id\",\"type\":\"string\"},{\"name\":\"appliance_id\",\"type\":\"string\"},{\"name\":\"user_name\",\"type\":\"string\",\"default\":\"\"},{\"name\":\"time\",\"type\":\"long\"}]}");
   ...
   */
  public static com.sd.kafka.avro.CombinedOrder.Builder newBuilder() {
    return new com.sd.kafka.avro.CombinedOrder.Builder();
  }
   ...
   * @return A new CombinedOrder RecordBuilder
   */
  public static com.sd.kafka.avro.CombinedOrder.Builder newBuilder(com.sd.kafka.avro.CombinedOrder.Builder other) {
    if (other == null) {
      return new com.sd.kafka.avro.CombinedOrder.Builder();
    } else {
      return new com.sd.kafka.avro.CombinedOrder.Builder(other);
    }
  }
   ...
   * @return A new CombinedOrder RecordBuilder
   */
  public static com.sd.kafka.avro.CombinedOrder.Builder newBuilder(com.sd.kafka.avro.CombinedOrder other) {
    if (other == null) {
      return new com.sd.kafka.avro.CombinedOrder.Builder();
    } else {
      return new com.sd.kafka.avro.CombinedOrder.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CombinedOrder>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.sd.kafka.avro.CombinedOrder.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.sd.kafka.avro.CombinedOrder other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.electronic_order_id)) {
        this.electronic_order_id = data().deepCopy(fields()[0].schema(), other.electronic_order_id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sd.kafka.avro.CombinedOrder.Builder setElectronicOrderId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sd.kafka.avro.CombinedOrder.Builder clearElectronicOrderId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sd.kafka.avro.CombinedOrder.Builder setApplianceOrderId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sd.kafka.avro.CombinedOrder.Builder clearApplianceOrderId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sd.kafka.avro.CombinedOrder.Builder setApplianceId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sd.kafka.avro.CombinedOrder.Builder clearApplianceId() {
      appliance_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sd.kafka.avro.CombinedOrder.Builder setUserName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sd.kafka.avro.CombinedOrder.Builder clearUserName() {
      user_name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sd.kafka.avro.CombinedOrder.Builder setTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sd.kafka.avro.CombinedOrder.Builder clearTime() {
