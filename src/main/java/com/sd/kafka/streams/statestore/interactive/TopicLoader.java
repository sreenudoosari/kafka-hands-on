...
public class TopicLoader {
    ...
    public static void runProducer() throws IOException {
        ...
        try(Admin adminClient = Admin.create(properties);
            ...
            String leftSideTopic = "stream_interactive_one.input.topic";
            String rightSideTopic = "stream_interactive_two.input.topic";
            String tableTopic = "stream_interactive_table.input.topic";
            ...
            ApplianceOrder applianceOrderTwo = ApplianceOrder.newBuilder()
                                                             .setApplianceId("stove-2333xy")
                                                             .setOrderId("remodel-2xy")
                                                             .setUserId("10261999")
                                                             .setTime(Instant.now().toEpochMilli()).build();
            ...
            ElectronicOrder electronicOrderTwo = ElectronicOrder.newBuilder()
                    .setElectronicId("laptop-5333xy")
                    .setOrderId("remodel-2x")
                    .setUserId("10261999")
                    .setTime(Instant.now().toEpochMilli()).build();
